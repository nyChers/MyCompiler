 ...
 * @Last modified time: 2017-11-09T11:48:07+08:00
 */
...
static const int keyword_num = 6;
static const char* keywords[] = {"int", "if", "else", "while", "do", "main"};
...
protected:
	...
	bool isSignwords(char*);//是否是标识符,不能以数字开头
